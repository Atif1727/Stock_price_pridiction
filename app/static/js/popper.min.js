...
function getCompositeRect(e, t, n) {
    ...
    return (
        (!i && (i || n)) ||
        (('body' === getNodeName(t) && !isScrollParent(r)) ||
            (a = getNodeScroll(t)),
            isHTMLElement(t)
                ? (((s = getBoundingClientRect(t)).x += t.clientLeft),
                    (s.y += t.clientTop))
                : r && (s.x = getWindowScrollBarX(r))),
        {
...
function getViewportRect(e) {
    ...
    return (
        ...
        { width: o, height: i, x: a + getWindowScrollBarX(e), y: s }
    )
}
function getDocumentRect(e) {
    var t = getDocumentElement(e),
        ...
        s = -n.scrollTop
    return (
        'rtl' === getComputedStyle(r || t).direction &&
...
function detectOverflow(e, t) {
    ...
    var r,
        ...
        O = getClippingRect(
            isElement(y)
                ? y
                : y.contextElement || getDocumentElement(e.elements.popper),
            a,
            c
        ),
                ...
                setOptions: function (e) {
                    i(),
                        (l.options = Object.assign(
                            Object.assign(Object.assign({}, c), l.options),
                            e
                        )),
                        (l.scrollParents = {
                            reference: isElement(r)
                                ? listScrollParents(r)
                                : r.contextElement
                                    ? listScrollParents(r.contextElement)
                                    : [],
                            popper: listScrollParents(o)
                        })
                    var t,
                        n = orderModifiers(mergeByName([].concat(s, l.options.modifiers)))
                    return (
                        ...
                        (validateModifiers(
                            uniqueBy([].concat(n, l.options.modifiers), function (e) {
                                return e.name
                            })
                        ),
                            getBasePlacement(l.options.placement) === auto &&
                            ...
                            [
                                (t = getComputedStyle(o)).marginTop,
                                t.marginRight,
                                t.marginBottom,
                                t.marginLeft
                            ].some(function (e) {
                        ...
                        l.orderedModifiers.forEach(function (e) {
                            var t,
                                ...
                                i = e.effect
                            'function' == typeof i &&
                                ((t = i({ state: l, name: n, instance: d, options: o })),
                                    a.push(t || function () { }))
                        }),
                        d.update()
                    )
                ...
                forceUpdate: function () {
                    if (!f) {
                        ...
                        if (areValidElements(t, n)) {
                            ...
                            for (
                                var r, o, i, a, s, c = 0, p = 0;
                                p < l.orderedModifiers.length;
                                p++
                            ) {
                                ...
                                !0 !== l.reset
                                    ? ((o = (r = l.orderedModifiers[p]).fn),
                                        (a = void 0 === (i = r.options) ? {} : i),
                                        (s = r.name),
                                        'function' == typeof o &&
                                        (l =
                                            o({ state: l, options: a, name: s, instance: d }) || l))
                                    : ((l.reset = !1), (p = -1))
                            }
                        } else
                            'production' !== process.env.NODE_ENV &&
...
function mapToStyles(e) {
    var t,
        ...
        b = window
    p &&
        ((n = getOffsetParent(r)) === getWindow(r) && (n = getDocumentElement(r)),
            i === top &&
            ((h = bottom), (d -= n.clientHeight - o.height), (d *= c ? 1 : -1)),
            i === left &&
            ((g = right), (f -= n.clientWidth - o.width), (f *= c ? 1 : -1)))
    var v,
        y = Object.assign({ position: s }, p && unsetSides)
    return c
        ? Object.assign(
            Object.assign({}, y),
            {},
...
function computeStyles(e) {
    ...
    null != n.modifiersData.popperOffsets &&
        ...
        (n.attributes.popper = Object.assign(
            Object.assign({}, n.attributes.popper),
            {},
...
function flip(e) {
    ...
    if (!n.modifiersData[r]._skip) {
        ...
        n.placement !== x &&
            ((n.modifiersData[r]._skip = !0), (n.placement = x), (n.reset = !0))
    }
}
var flip$1 = {
    name: 'flip',
    ...
    z &&
        (I &&
            ((t = 'y' === X ? top : left),
                ...
                (p = G === start ? -K[r] : -J[r]),
                (l = N.elements.arrow),
                (f = k && l ? getLayoutRect(l) : { width: 0, height: 0 }),
                (u = (d = N.modifiersData['arrow#persistent']
                    ? N.modifiersData['arrow#persistent'].padding
                    : getFreshSideObject())[t]),
                (m = d[n]),
                (g = within(0, J[r], f[r])),
                (h = U ? J[r] / 2 - s - g - u - Q : c - g - u - Q),
                (b = U ? -J[r] / 2 + s + g + m + Q : p + g + m + Q),
                (y = (v = N.elements.arrow && getOffsetParent(N.elements.arrow))
                    ? 'y' === X
                        ? v.clientTop || 0
                        : v.clientLeft || 0
                    : 0),
...
function arrow(e) {
    ...
    b &&
        v &&
        ((n = g.modifiersData[h + '#persistent'].padding),
            (r = getLayoutRect(b)),
            (o = 'y' === O ? top : left),
            (i = 'y' === O ? bottom : right),
            (a =
                g.rects.reference[w] + g.rects.reference[O] - v[O] - g.rects.popper[w]),
            (s = v[O] - g.rects.reference[O]),
            (p = (c = getOffsetParent(b))
                ? 'y' === O
                    ? c.clientHeight || 0
                    : c.clientWidth || 0
                : 0),
            ...
            (g.modifiersData[h] = (((t = {})[O] = m), (t.centerOffset = m - u), t)))
}
function effect$2(e) {
    var t = e.state,
        n = e.options,
